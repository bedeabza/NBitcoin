...
{
	// Reference: https://github.com/gincoin-dev/gincoin-core/blob/master/src/chainparams.cpp
...
#pragma warning disable CS0618 // Type or member is obsolete
		...
		{
			// https://github.com/gincoin-dev/gincoin-core/blob/master/src/primitives/block.cpp#L24
			static byte[] CalculateHash(byte[] data, int offset, int count)
			{
			    // @TODO return the Lyra2Z hash
...
#pragma warning restore CS0618 // Type or member is obsolete
		...
		protected override NetworkBuilder CreateTestnet()
		{
			...
			.SetRPCPort(12211)
			.SetMaxP2PVersion(70208)
		   .SetName("gincoin-test")
		   .AddAlias("gincoin-testnet")
		   .AddDNSSeeds(new[]
		   {
